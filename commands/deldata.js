...
const message = 'messageCreate'
    module.exports.run = async(client, message, args) => {
          ...
          let msg = await message.reply('⏳ -> Removing server data, when done the bot will let you know...');
      msg.edit('⏳ -> Checking database (0%)')
      if (!filelog[message.guild.id]) {
      msg.edit("The bot hasn't collected any data about your server yet")
        return;
      }
    delete filelog[message.guild.id]
      msg.edit('⏳ -> Deleted modlogs settings (100%)')
